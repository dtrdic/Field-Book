...
//            }
    ...
    private void loadScreen() {
        ...
        Integer[] image_id = {
                ...
                R.drawable.ic_nav_drawer_traits,
                R.drawable.ic_nav_drawer_collect_data,
                R.drawable.trait_date_save,
        ...
        if (useKmp) {
            image_id = ArrayUtils.add(image_id, R.drawable.kotlin_icon_2021);
        }
