...
class PreferenceKeys {
    companion object {
        ...
        const val USE_FLUTTER = "com.tracker.fieldbook.preferences.keys.use_flutter"

        private val experimentalPreferenceKeys = setOf(REPEATED_VALUES_PREFERENCE_KEY, MEDIA_KEYCODE_NAVIGATION, MLKIT_PREFERENCE_KEY,
            ENABLE_FIELD_AUDIO, EXPERIMENTAL_NEW_BRAPI_UI, USE_FLUTTER)
